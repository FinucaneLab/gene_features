...
# Notes on data:
# No annotations provided. We run the integration pipeline.
...
marker_genes <- c("PCNA", "MKI67", "FGFBP2", "FCGR3A", "PRF1", "S1PR5", "GZMB", "ISG15", "IFI6", "LTB", "TNFS", "GZMK", "JUNB", "CD3D", "CD3E", "CD3G", "IGHG1", "IGHG2", "JCHAIN", "LYZ", "MLANA")
