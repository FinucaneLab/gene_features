...
# Data is provided in batches, so we run the integration pipeline
...
filelist = c(paste0("../data/", name, "/GSM4318799_1M_matrix.txt.gz"),
             paste0("../data/", name, "/GSM4318800_1.5M_matrix.txt.gz"),
             paste0("../data/", name, "/GSM4318801_3M_matrix.txt.gz"),
             paste0("../data/", name, "/GSM4318802_16M_matrix.txt.gz"))
...
marker_genes <- c("SATB2", "MEF2C", "ATF3", "SATB1", "THRA", "RORA", "ELF1", "HOXA10", "EBF1", "EBF3", "RUNX1", "STAT1", "REL", "JUNB", "MSC", "UHRF2", "KIF2")
