...
file <- paste0("../data/", name, "/Table_fetal_all_cell_pass_filtering_count.txt.gz")
...
marker_genes <- c("SFTPC", "ID2", "HMGA1", "TP63", "SFTPC", "ID2", "HMGA1", "KRT5", "FOXJ1", "SCGB1A1", "AGER", "KRT15", "IL33", "PDPN", "EPCAM", "HOPX")
