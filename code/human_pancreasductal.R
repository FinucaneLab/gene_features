...
file <- paste0("../data/", name, "/GSE131886_alk3n3_gene_expression_matrix.csv.gz")
...
marker_genes <- c("KRT19", "SOX9", "BMPR1A", "CDH1", "AMY2B", "ISL1", "INS", "GCG", "SST", "PPY")
