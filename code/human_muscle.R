...
# Notes on data:
# No annotations provided. Data provided in multiple files but we don't observe any batch effects.
...
marker_genes <- c("FABP4", "IF27", "VWF", "APOD", "LUM", "DCN", "APOC1", "APOE", "MYF5", "GNLY", "DARC", "CCL14", "PLVAP", "PERGL", "MYH11", "PLN", "CD3D", "IL7R", "LTB", "AIF1", "MS4A1", "TCL1A", "FCRL1")
