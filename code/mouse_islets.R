...
# Notes on data:
# Some gene and cell level data are provided but we mostly have no use for these annotations
# There are rows for spike-ins but they appear to be empty. Might just be placeholders. We ignore them.

#------------------------------------------------LOAD AND FORMAT DATA-----------------------------------------------#

# Read in data and annotations
file <- paste0("../data/", name, "/GSE121416_genes.fpkm_table.txt.gz")
