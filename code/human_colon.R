...
filelist = c(paste0("../data/", name, "/GSE95435_P150057_full_gene_count_table.txt.gz"),
             paste0("../data/", name, "/GSE95450_P160099_full_gene_count_table.txt.gz"),
             paste0("../data/", name, "/GSE95446_P150409_full_gene_count_table.txt.gz"))
...
marker_genes <- c("VIM", "COL1A2", "COL3A1", "MYH11", "ACTG2", "ADAMDEC1", "DCN", "SLIT2", "CXCL12", "WNT5A", "WNT5B", "BMP2", "BMP5", "FRZB", "POSTN", "HSD17B2")
