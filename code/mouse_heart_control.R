...
filelist = c(paste0("../data/", name, "/GSM3332251_Ctrl-P6-1_gene_exonic.intronic_tagged.dge.txt.gz"),
             paste0("../data/", name, "/GSM3332252_Ctrl-P6-2_gene_exonic.intronic_tagged.dge.txt.gz"),
             paste0("../data/", name, "/GSM3332253_Ctrl-P6-3_gene_exonic.intronic_tagged.dge.txt.gz"),
             paste0("../data/", name, "/GSM3332254_Ctrl-P10-1_gene_exonic.intronic_tagged.dge.txt.gz"),
             paste0("../data/", name, "/GSM3332255_Ctrl-P10-2_gene_exonic.intronic_tagged.dge.txt.gz"),
             paste0("../data/", name, "/GSM3332256_Ctrl-P10-3_gene_exonic.intronic_tagged.dge.txt.gz"))
...
marker_genes <- c("PIN", "ACTC1", "TNNC1", "ATP5B", "NDUFA4", "COX5A", "MKI67", "CENPP", "KIF15", "GATA4", "MYOCD")
