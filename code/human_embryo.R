...
file <- paste0("../data/", name, "/GSE109555_All_Embryo_TPM.txt.gz")
...
marker_genes <- c("KHDC3L", "TDGF1", "CXCL12", "THY1", "LEFTY2", "PRICKLE1", "SP7", "RAMP2", "PSG6", "ARG1", "SEMA3B", "LAMB3", "LAC1", "EDN1", "CNR1", "SALL1", "NGF", "EGFR", "TAC1", "DKK3", "EMP2", "INSL4", "ITGB3", "PSG8", "LAMP3")
