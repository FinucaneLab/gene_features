...
marker_genes <- c("NANOS3", "GFRA1", "ETV5", "ED4", "NANOS2", "SOHLH1", "RHOXF1", "MAGEA4", "ZBTB16", "BCL6B", "UCHL1", "FOXO1", "DMRT1", "KIT", "STRA8", "PEG10", "GAL3ST1", "SPO11", "MEIOB", "DAZL", "ATR", "NEUROG3", "ACR", "SAXO1", "ACRV1", "RBM5", "TXNDC8", "PRM1", "CA2", "CLU", "AIF1", "CD68", "CX3CR1", "WT1", "GATA4", "NR5A1", "STAR", "CYP11A1", "MYH11")
