...
marker_genes <- c("ANK2", "CLU", "MMP20", "CLDN10", "PTHLH", "IGFBBL1", "BIRC5", "CCNB1", "SPARCL1", "LGFBP2", "KRT15", "DCN", "KRT17", "TACSTD2", "HES1", "ENPP2", "UNG", "TOP2A", "CDC20", "CCNB2")
