...
# Notes on data:
# There are a few ENST IDs at the end that we drop

#------------------------------------------------LOAD AND FORMAT DATA-----------------------------------------------#

# Read in data and annotations
file <- paste0("../data/", name, "/GSE89497_Human_Placenta_TMP_V2.txt.gz")
...
marker_genes <- c("HLA-G", "CDH1", "HLA-A", "VIM", "CD14", "CD68", "THY1", "CK7", "TFAP2C", "GATA3", "CDH1", "EGFR", "MMP2", "CG8", "CSH1")
