...
# Parameters
name <- "human_brain_cerebellarhem"
number_pcs <- 30
vargenes <- 1600
clus_res <- 1.0
...
file <- paste0("../data/", name, "/GSE97930_CerebellarHem_snDrop-seq_UMI_Count_Matrix_08-01-2017.txt.gz")
...
# UMAP dim reduction
so <- RunUMAP(so, dims = 1:number_pcs, min.dist = 0.6, n.epochs = 500,
