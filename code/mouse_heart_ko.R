...
filelist = c(paste0("../data/", name, "/GSM3332257_KO-P10-1_gene_exonic.intronic_tagged.dge.txt.gz"),
             paste0("../data/", name, "/GSM3332258_KO-P10-2_gene_exonic.intronic_tagged.dge.txt.gz"),
             paste0("../data/", name, "/GSM3332259_KO-P10-3_gene_exonic.intronic_tagged.dge.txt.gz"))
